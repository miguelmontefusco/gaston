...
<div class="row">
  ...
  <div class="col l12 m12 s12 text-slider" style="padding:0px;">
    ...
    <div class="col l4 m12 s12 relative margin-80">
       <?php echo do_shortcode('[text-blocks id="52"]'); ?>
    </div>
    <!--Est video -->
    <div class="col l8 m12 s12 center video-arriba">          
   <?php $videos = get_field("slider_video", 98); ?>
     <div class="col s12 m12 l12 remove-control galeria-vid nopadding">
        <ul class="bxsliderr">
      		<?php foreach ($videos as $key => $value) {?>
          <li>
          	<?php 	echo "<iframe class='video' src='https://www.youtube.com/embed/".$value['url_video']."' frameborder='0' allowfullscreen></iframe>"; }?>
          </li>
        </ul>
     </div>
      <div class="col s12 m12 l12 control-vid tumbs-galeria-vid">
      <?php	$videos = get_field("slider_video", 98);  ?>        
        <div id="bx-pagerr">
          <ul id="slider4">           		
  			<?php 
  ...
  <div class="col l12 m12 s12 slider-articulos slider-dos remove-control slider-normal" style="padding:0px;">
	         ...
	         <li>
	      		<div class="col s12 m12 l12">
	                <div class="col s12 m6 l5">              
	                  <img src="<?php echo $url ?>" class="image-book hide-on-small-only">
	                </div>

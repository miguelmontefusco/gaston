					...
					<div class="wonderplugin-gallery-options-tabs" id="wonderplugin-gallery-options-tabs">
						...
						<div class="wonderplugin-gallery-options-tab">
							<table class="wonderplugin-form-table-noborder">
								...
								<p><label for="wonderplugin-gallery-showfacebook"><input name="wonderplugin-gallery-showfacebook" type="checkbox" id="wonderplugin-gallery-showfacebook" /> Show Facebook button</label>
